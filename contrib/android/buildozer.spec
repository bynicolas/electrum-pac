...
source.exclude_dirs = bin, build, dist, contrib,
    electrum_pac/tests,
    electrum_pac/gui/qt,
    electrum_pac/gui/kivy/theming/light,
    packages/qtpy
...
presplash.filename = %(source.dir)s/electrum_pac/gui/icons/electrum_presplash.png

# (str) Icon of the application
icon.filename = %(source.dir)s/electrum_pac/gui/icons/electrum-pac.png
...
p4a.local_recipes = %(source.dir)s/contrib/pac/p4a
