...
from electrum_pac.util import make_dir, InvalidPassword, UserCancelled
from electrum_pac.gui.qt.util import (read_QIcon, EnterButton, WWLabel, icon_path,
...
class Plugin(RevealerPlugin):
    ...
    def password_dialog(self, msg=None, parent=None):
        from electrum_pac.gui.qt.password_dialog import PasswordDialog
