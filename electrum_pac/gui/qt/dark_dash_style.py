...
import os
from electrum_pac.util import pkg_dir
...
#main_window_nav_bar > QTabBar::tab:selected, #main_window0_nav_bar > QTabBar::tab:hover {
...
QDialog QTabWidget QTabBar::tab:first {
    border-left: 1px solid #333f54;
}

QDialog QTabWidget QTabBar::tab:last {
    border-right: 1px solid #333f54;
}
