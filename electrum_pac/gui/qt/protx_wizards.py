...
from electrum_pac import dash_tx
from electrum_pac.bitcoin import COIN, is_b58_address, b58_address_to_hash160
from electrum_pac.dash_tx import TxOutPoint, service_to_ip_port
from electrum_pac.protx import ProTxMN, ProTxService, ProRegTxExc
from electrum_pac.util import bfh, bh2u, FILE_OWNER_MODE
...
class CollateralWizardPage(QWizardPage):
    ...
    def scan_for_outputs(self):
        ...
        coins = list(filter(lambda x: (x.value_sats() == (500000 * COIN)),
                                       coins))
...
class Dip3MasternodeWizard(QWizard):
    ...
    def validate_collateral(self, outpoint, addr, value, skip_alias=None):
        ...
        if not value == 500000 * COIN or not value == c_vin.value_sats():
