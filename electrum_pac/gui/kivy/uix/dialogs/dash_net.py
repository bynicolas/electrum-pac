...
#:import MIN_PEERS_LIMIT electrum_pac.dash_net.MIN_PEERS_LIMIT
#:import MAX_PEERS_LIMIT electrum_pac.dash_net.MAX_PEERS_LIMIT
...
<DashNetDataFlowDialog@Popup>
    title: _('Data flow over PacGlobal network')
    data: data
    ScrollView:
        Label:
            id: data
