...
from electrum_pac.dash_ps import filter_log_line, PSLogSubCat, PSStates
...
from electrum_pac.gui.kivy.uix.dialogs.question import Question


Builder.load_string('''
#:import _ electrum_pac.gui.kivy.i18n._
#:import SpinBox electrum_pac.gui.kivy.uix.spinbox.SpinBox
...
<EXWarnPopup@Popup>
    ...
    BoxLayout:
        ...
        orientation: 'vertical'
        Image:
            source:'atlas://electrum_pac/gui/kivy/theming/light/error'
            size_hint_y: 0.1
        Label:
            size_hint_y: 0.4
            id: warn_msg
