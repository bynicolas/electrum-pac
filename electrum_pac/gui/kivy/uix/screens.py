...
from electrum_pac.invoices import (PR_TYPE_ONCHAIN, PR_DEFAULT_EXPIRATION_WHEN_CREATING,
                                    PR_PAID, PR_UNKNOWN, PR_EXPIRED, PR_INFLIGHT,
                                    pr_expiration_values, Invoice, OnchainInvoice,
                                    InvoiceExt)
from electrum_pac import bitcoin, constants
from electrum_pac.transaction import Transaction, tx_from_any, PartialTransaction, PartialTxOutput
from electrum_pac.util import parse_URI, InvalidBitcoinURI, TxMinedInfo
from electrum_pac.plugin import run_hook
from electrum_pac.wallet import InternalAddressCorruption
from electrum_pac import simple_config
from electrum_pac.simple_config import FEERATE_WARNING_HIGH_FEE, FEE_RATIO_HIGH_WARNING
from electrum_pac.logging import Logger
from electrum_pac.dash_tx import PSTxTypes, SPEC_TX_NAMES

from .dialogs.question import Question
from .context_menu import ContextMenu

from electrum_pac.gui.kivy import KIVY_GUI_PATH
from electrum_pac.gui.kivy.i18n import _

if TYPE_CHECKING:
    from electrum_pac.gui.kivy.main_window import ElectrumWindow
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_pac.util import create_bip21_uri
        amount = self.amount
        if amount:
