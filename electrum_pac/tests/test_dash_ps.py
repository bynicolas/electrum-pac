...
from electrum_pac import dash_ps, ecc
from electrum_pac.address_synchronizer import (TX_HEIGHT_LOCAL,
                                                TX_HEIGHT_UNCONF_PARENT,
                                                TX_HEIGHT_UNCONFIRMED)
from electrum_pac.dash_ps import (COLLATERAL_VAL, PSPossibleDoubleSpendError,
...
from electrum_pac.transaction import (Transaction, PartialTxOutput,
                                       PartialTransaction)
from electrum_pac.util import Satoshis, NotEnoughFunds, TxMinedInfo, bh2u
...
class PSWalletTestCase(TestCaseForTestnet):
    ...
    def test_calc_need_denoms_amounts_on_keep_amount(self):
        ...
        assert sum([c.value_sats() for c in coins]) == 50000000  # 0.5 PacGlobal
    ...
    def test_prepare_funds_from_hw_wallet(self):
        ...
        assert sum([c.value_sats() for c in coins]) == 350002000  # 3.5 PacGlobal
