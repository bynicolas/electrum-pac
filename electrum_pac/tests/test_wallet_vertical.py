...
from electrum_pac import storage, bitcoin, keystore, bip32, wallet
from electrum_pac import Transaction
from electrum_pac import SimpleConfig
from electrum_pac.address_synchronizer import TX_HEIGHT_UNCONFIRMED, TX_HEIGHT_UNCONF_PARENT
from electrum_pac.wallet import sweep, Multisig_Wallet, Standard_Wallet, Imported_Wallet, restore_wallet_from_text, Abstract_Wallet
from electrum_pac.util import bfh, bh2u
from electrum_pac.transaction import TxOutput, Transaction, PartialTransaction, PartialTxOutput, PartialTxInput, tx_from_any
from electrum_pac.mnemonic import seed_type
...
class TestWalletOfflineSigning(TestCaseForTestnet):
    ...
    def test_offline_signing_beyond_gap_limit(self, mock_save_db):
        ...
        self.assertEqual(1, len(tx.inputs()))
        partial_tx = tx.serialize_as_bytes().hex()
        self.assertEqual("",
                         partial_tx)
        tx_copy = tx_from_any(partial_tx)  # simulates moving partial txn between cosigners
        self.assertTrue(wallet_online.is_mine(wallet_online.get_txin_address(tx_copy.inputs()[0])))
